...
class HomepageView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            # Only display tools which have at less one member and are enabled
            ...
            'tool_list': Tool.objects.annotate(num_members=Count('userprofile')).filter(num_members__gte=1, enabled=True).order_by('-picture'),
